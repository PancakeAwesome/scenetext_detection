...
#就是一个dict的子类，但是功能变的更加简洁，如添加元素不需要setdefault()，只需要'.'操作即可
__C = edict()
...
#该root_dir 操作方式：__file__为该config.py文件的路径，所有总路径为abs（__file__/../..）此时即为Fsater-ECNN_TF目录
__C.ROOT_DIR = osp.abspath(osp.join(osp.dirname(__file__), '..', '..'))

# Data directory
#osp.join为os.path.join，osp.join(‘home‘，’ubuntu‘，’lijing‘)返回’home/ubuntu/lijing‘
...
#由__C.ROOT_DIR可知 Fsater-ECNN_TF/data
__C.DATA_DIR = osp.abspath(osp.join(__C.ROOT_DIR, 'data'))

# Model directory
#Fsater-ECNN_TF/models/pascal_voc
